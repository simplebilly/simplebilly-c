...
**product_id** | **char \*** | The parent product this variant belongs to. References the product entity. | [optional] 
**sku** | **char \*** | Variant-specific SKU (must be unique per tenant). | [optional] 
