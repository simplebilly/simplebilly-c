...
------------ | ------------- | ------------- | -------------
**currency** | **char \*** | Currency for the minimum order value. | [optional] 
...
**supplier_contact_id** | **char \*** | The supplier this condition applies to (&#x60;contact_id&#x60;). References the supplier entity. | [optional] 
