...
**description** | **char \*** | What the job is; markdown/HTML. | [optional] 
**employment_type** | **employment_type_t \*** | full_time | part_time | contract | internship | temporary | [optional] 
**location** | **char \*** |  | [optional] 
**remote** | **int** |  | [optional] 
**required_skills** | **any_type_t \*** | List of required skill names (JSON array of strings). | [optional] 
...
**status** | **job_posting_status_t \*** | draft | published | closed | [optional] 
**title** | **char \*** |  | [optional] 
