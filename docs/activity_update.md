...
------------ | ------------- | ------------- | -------------
**activity_type** | **activity_type_t \*** | One of: call | email | meeting | task | note | [optional] 
...
**status** | **activity_status_t \*** | One of: open | done | cancelled | [optional] 
**subject** | **char \*** | Short subject line. | [optional] 
