...
EmployeeAPI_createEmployee(apiClient_t *apiClient, employee_create_t *employee_create)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/employees");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_employee_create = NULL;
    if (employee_create != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_employee_create = employee_create_convertToJSON(employee_create);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_employee_create);
    ...
    employee_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *EmployeeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = employee_parseFromJSON(EmployeeAPIlocalVarJSON);
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_employee_create) {
        cJSON_Delete(localVarSingleItemJSON_employee_create);
        localVarSingleItemJSON_employee_create = NULL;
    }
...
EmployeeAPI_deleteEmployee(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/employees/{id}");
...
EmployeeAPI_employeeRestore(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/employees/{id}/restore");
...
EmployeeAPI_getEmployeePayrollSummary(apiClient_t *apiClient, char *id, int *year)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/employees/{id}/payroll-summary");
    ...
    // uncomment below to debug the error response
    //if (apiClient->response_code == 200) {
    //    printf("%s\n","Payroll summary for the employee");
    //}
    // uncomment below to debug the error response
    //if (apiClient->response_code == 404) {
    //    printf("%s\n","Employee not found");
    ...
    //}
    //nonprimitive not container
    payroll_summary_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *EmployeeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = payroll_summary_parseFromJSON(EmployeeAPIlocalVarJSON);
        cJSON_Delete(EmployeeAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
EmployeeAPI_updateEmployee(apiClient_t *apiClient, char *id, employee_update_t *employee_update)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_employee_update = NULL;
    if (employee_update != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_employee_update = employee_update_convertToJSON(employee_update);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_employee_update);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(localVarPath);
    free(localVarToReplace_id);
    if (localVarSingleItemJSON_employee_update) {
        cJSON_Delete(localVarSingleItemJSON_employee_update);
        localVarSingleItemJSON_employee_update = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
