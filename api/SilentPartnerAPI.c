...
SilentPartnerAPI_createSilentPartner(apiClient_t *apiClient, silent_partner_create_t *silent_partner_create)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/silent-partners");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_silent_partner_create = NULL;
    if (silent_partner_create != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_silent_partner_create = silent_partner_create_convertToJSON(silent_partner_create);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_silent_partner_create);
    ...
    silent_partner_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *SilentPartnerAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = silent_partner_parseFromJSON(SilentPartnerAPIlocalVarJSON);
        cJSON_Delete(SilentPartnerAPIlocalVarJSON);
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_silent_partner_create) {
        cJSON_Delete(localVarSingleItemJSON_silent_partner_create);
        localVarSingleItemJSON_silent_partner_create = NULL;
    }
...
SilentPartnerAPI_deleteSilentPartner(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/silent-partners/{id}");
...
SilentPartnerAPI_getSilentPartners(apiClient_t *apiClient, int *page, int *page_size, char *search, int *include_deleted)
{
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *SilentPartnerAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        if(!cJSON_IsArray(SilentPartnerAPIlocalVarJSON)) {
            return 0;//nonprimitive container
        }
        elementToReturn = list_createList();
        cJSON *VarJSON;
        cJSON_ArrayForEach(VarJSON, SilentPartnerAPIlocalVarJSON)
        {
...
SilentPartnerAPI_updateSilentPartner(apiClient_t *apiClient, char *id, silent_partner_update_t *silent_partner_update)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_silent_partner_update = NULL;
    if (silent_partner_update != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_silent_partner_update = silent_partner_update_convertToJSON(silent_partner_update);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_silent_partner_update);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(localVarPath);
    free(localVarToReplace_id);
    if (localVarSingleItemJSON_silent_partner_update) {
        cJSON_Delete(localVarSingleItemJSON_silent_partner_update);
        localVarSingleItemJSON_silent_partner_update = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
