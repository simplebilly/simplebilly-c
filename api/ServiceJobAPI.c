...
ServiceJobAPI_createServiceJob(apiClient_t *apiClient, service_job_create_t *service_job_create)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/service-jobs");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_job_create = NULL;
    if (service_job_create != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_service_job_create = service_job_create_convertToJSON(service_job_create);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_job_create);
    ...
    service_job_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ServiceJobAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = service_job_parseFromJSON(ServiceJobAPIlocalVarJSON);
        cJSON_Delete(ServiceJobAPIlocalVarJSON);
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_service_job_create) {
        cJSON_Delete(localVarSingleItemJSON_service_job_create);
        localVarSingleItemJSON_service_job_create = NULL;
    }
...
ServiceJobAPI_deleteServiceJob(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/service-jobs/{id}");
...
ServiceJobAPI_getServiceJobs(apiClient_t *apiClient, int *page, int *page_size, char *search, int *include_deleted)
{
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ServiceJobAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        if(!cJSON_IsArray(ServiceJobAPIlocalVarJSON)) {
            return 0;//nonprimitive container
        }
        elementToReturn = list_createList();
        cJSON *VarJSON;
        cJSON_ArrayForEach(VarJSON, ServiceJobAPIlocalVarJSON)
        {
...
ServiceJobAPI_updateServiceJob(apiClient_t *apiClient, char *id, service_job_update_t *service_job_update)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_job_update = NULL;
    if (service_job_update != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_service_job_update = service_job_update_convertToJSON(service_job_update);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_job_update);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(localVarPath);
    free(localVarToReplace_id);
    if (localVarSingleItemJSON_service_job_update) {
        cJSON_Delete(localVarSingleItemJSON_service_job_update);
        localVarSingleItemJSON_service_job_update = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
