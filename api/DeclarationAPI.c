...
DeclarationAPI_createDeclaration(apiClient_t *apiClient, declaration_create_t *declaration_create)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/declarations");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_declaration_create = NULL;
    if (declaration_create != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_declaration_create = declaration_create_convertToJSON(declaration_create);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_declaration_create);
    ...
    declaration_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *DeclarationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = declaration_parseFromJSON(DeclarationAPIlocalVarJSON);
        cJSON_Delete(DeclarationAPIlocalVarJSON);
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_declaration_create) {
        cJSON_Delete(localVarSingleItemJSON_declaration_create);
        localVarSingleItemJSON_declaration_create = NULL;
    }
...
DeclarationAPI_declarationRestore(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/declarations/{id}/restore");
...
DeclarationAPI_deleteDeclaration(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/declarations/{id}");
...
DeclarationAPI_getDeclarations(apiClient_t *apiClient, int *page, int *page_size, char *search, int *include_deleted)
{
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *DeclarationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        if(!cJSON_IsArray(DeclarationAPIlocalVarJSON)) {
            return 0;//nonprimitive container
        }
        elementToReturn = list_createList();
        cJSON *VarJSON;
        cJSON_ArrayForEach(VarJSON, DeclarationAPIlocalVarJSON)
        {
...
DeclarationAPI_updateDeclaration(apiClient_t *apiClient, char *id, declaration_update_t *declaration_update)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_declaration_update = NULL;
    if (declaration_update != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_declaration_update = declaration_update_convertToJSON(declaration_update);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_declaration_update);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(localVarPath);
    free(localVarToReplace_id);
    if (localVarSingleItemJSON_declaration_update) {
        cJSON_Delete(localVarSingleItemJSON_declaration_update);
        localVarSingleItemJSON_declaration_update = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
