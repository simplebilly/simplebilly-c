...
ServiceAssignmentAPI_createServiceAssignment(apiClient_t *apiClient, service_assignment_create_t *service_assignment_create)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/service-assignments");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_assignment_create = NULL;
    if (service_assignment_create != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_service_assignment_create = service_assignment_create_convertToJSON(service_assignment_create);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_assignment_create);
    ...
    service_assignment_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ServiceAssignmentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = service_assignment_parseFromJSON(ServiceAssignmentAPIlocalVarJSON);
        cJSON_Delete(ServiceAssignmentAPIlocalVarJSON);
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_service_assignment_create) {
        cJSON_Delete(localVarSingleItemJSON_service_assignment_create);
        localVarSingleItemJSON_service_assignment_create = NULL;
    }
...
ServiceAssignmentAPI_deleteServiceAssignment(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/service-assignments/{id}");
...
ServiceAssignmentAPI_getServiceAssignments(apiClient_t *apiClient, int *page, int *page_size, char *search, int *include_deleted)
{
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ServiceAssignmentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        if(!cJSON_IsArray(ServiceAssignmentAPIlocalVarJSON)) {
            return 0;//nonprimitive container
        }
        elementToReturn = list_createList();
        cJSON *VarJSON;
        cJSON_ArrayForEach(VarJSON, ServiceAssignmentAPIlocalVarJSON)
        {
...
ServiceAssignmentAPI_updateServiceAssignment(apiClient_t *apiClient, char *id, service_assignment_update_t *service_assignment_update)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_assignment_update = NULL;
    if (service_assignment_update != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_service_assignment_update = service_assignment_update_convertToJSON(service_assignment_update);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_assignment_update);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(localVarPath);
    free(localVarToReplace_id);
    if (localVarSingleItemJSON_service_assignment_update) {
        cJSON_Delete(localVarSingleItemJSON_service_assignment_update);
        localVarSingleItemJSON_service_assignment_update = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
