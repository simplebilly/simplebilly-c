...
ParticipationAPI_createParticipation(apiClient_t *apiClient, participation_create_t *participation_create)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/participations");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_participation_create = NULL;
    if (participation_create != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_participation_create = participation_create_convertToJSON(participation_create);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_participation_create);
    ...
    participation_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ParticipationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = participation_parseFromJSON(ParticipationAPIlocalVarJSON);
        cJSON_Delete(ParticipationAPIlocalVarJSON);
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_participation_create) {
        cJSON_Delete(localVarSingleItemJSON_participation_create);
        localVarSingleItemJSON_participation_create = NULL;
    }
...
ParticipationAPI_deleteParticipation(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/participations/{id}");
...
ParticipationAPI_getParticipations(apiClient_t *apiClient, int *page, int *page_size, char *search, int *include_deleted)
{
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ParticipationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        if(!cJSON_IsArray(ParticipationAPIlocalVarJSON)) {
            return 0;//nonprimitive container
        }
        elementToReturn = list_createList();
        cJSON *VarJSON;
        cJSON_ArrayForEach(VarJSON, ParticipationAPIlocalVarJSON)
        {
...
ParticipationAPI_updateParticipation(apiClient_t *apiClient, char *id, participation_update_t *participation_update)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_participation_update = NULL;
    if (participation_update != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_participation_update = participation_update_convertToJSON(participation_update);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_participation_update);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(localVarPath);
    free(localVarToReplace_id);
    if (localVarSingleItemJSON_participation_update) {
        cJSON_Delete(localVarSingleItemJSON_participation_update);
        localVarSingleItemJSON_participation_update = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
