...
#include "ComplianceTrainingAPI.h"
...
ComplianceTrainingAPI_createComplianceTraining(apiClient_t *apiClient, compliance_training_create_t *compliance_training_create)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/compliance-trainings");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_compliance_training_create = NULL;
    if (compliance_training_create != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_compliance_training_create = compliance_training_create_convertToJSON(compliance_training_create);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_compliance_training_create);
    ...
    compliance_training_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ComplianceTrainingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = compliance_training_parseFromJSON(ComplianceTrainingAPIlocalVarJSON);
        cJSON_Delete(ComplianceTrainingAPIlocalVarJSON);
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_compliance_training_create) {
        cJSON_Delete(localVarSingleItemJSON_compliance_training_create);
        localVarSingleItemJSON_compliance_training_create = NULL;
    }
...
ComplianceTrainingAPI_deleteComplianceTraining(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/compliance-trainings/{id}");
...
ComplianceTrainingAPI_getComplianceTrainings(apiClient_t *apiClient, int *page, int *page_size, char *search, int *include_deleted)
{
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ComplianceTrainingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        if(!cJSON_IsArray(ComplianceTrainingAPIlocalVarJSON)) {
            return 0;//nonprimitive container
        }
        elementToReturn = list_createList();
        cJSON *VarJSON;
        cJSON_ArrayForEach(VarJSON, ComplianceTrainingAPIlocalVarJSON)
        {
...
ComplianceTrainingAPI_updateComplianceTraining(apiClient_t *apiClient, char *id, compliance_training_update_t *compliance_training_update)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_compliance_training_update = NULL;
    if (compliance_training_update != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_compliance_training_update = compliance_training_update_convertToJSON(compliance_training_update);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_compliance_training_update);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(localVarPath);
    free(localVarToReplace_id);
    if (localVarSingleItemJSON_compliance_training_update) {
        cJSON_Delete(localVarSingleItemJSON_compliance_training_update);
        localVarSingleItemJSON_compliance_training_update = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
