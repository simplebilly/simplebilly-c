...
CustomerGroupAPI_addGroupMembers(apiClient_t *apiClient, char *customer_group_id, body)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/customer-groups/{customer_group_id}/members");
    ...
    // Path Params
    long sizeOfPathParams_customer_group_id = strlen(customer_group_id)+3 + sizeof("{ customer_group_id }") - 1;
    if(customer_group_id == NULL) {
        goto end;
    }
    char* localVarToReplace_customer_group_id = malloc(sizeOfPathParams_customer_group_id);
    sprintf(localVarToReplace_customer_group_id, "{%s}", "customer_group_id");

    localVarPath = strReplace(localVarPath, localVarToReplace_customer_group_id, customer_group_id);
    ...
    customer_group_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *CustomerGroupAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = customer_group_parseFromJSON(CustomerGroupAPIlocalVarJSON);
        cJSON_Delete(CustomerGroupAPIlocalVarJSON);
    ...
    free(localVarPath);
    free(localVarToReplace_customer_group_id);
...
CustomerGroupAPI_createCustomerGroup(apiClient_t *apiClient, customer_group_create_t *customer_group_create)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/customer-groups");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_customer_group_create = NULL;
    if (customer_group_create != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_customer_group_create = customer_group_create_convertToJSON(customer_group_create);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_customer_group_create);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    list_freeList(localVarContentType);
    free(localVarPath);
    if (localVarSingleItemJSON_customer_group_create) {
        cJSON_Delete(localVarSingleItemJSON_customer_group_create);
        localVarSingleItemJSON_customer_group_create = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
CustomerGroupAPI_deleteCustomerGroup(apiClient_t *apiClient, char *customer_group_id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v1/customer-groups/{customer_group_id}");
...
CustomerGroupAPI_listCustomerGroups(apiClient_t *apiClient, int *page, int *page_size, char *search, int *include_deleted)
{
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *CustomerGroupAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        if(!cJSON_IsArray(CustomerGroupAPIlocalVarJSON)) {
            return 0;//nonprimitive container
        }
        elementToReturn = list_createList();
        cJSON *VarJSON;
        cJSON_ArrayForEach(VarJSON, CustomerGroupAPIlocalVarJSON)
        {
...
CustomerGroupAPI_updateCustomerGroup(apiClient_t *apiClient, char *customer_group_id, customer_group_update_t *customer_group_update)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_customer_group_update = NULL;
    if (customer_group_update != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_customer_group_update = customer_group_update_convertToJSON(customer_group_update);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_customer_group_update);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(localVarPath);
    free(localVarToReplace_customer_group_id);
    if (localVarSingleItemJSON_customer_group_update) {
        cJSON_Delete(localVarSingleItemJSON_customer_group_update);
        localVarSingleItemJSON_customer_group_update = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
