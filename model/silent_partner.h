...
#ifndef _silent_partner_H_
#define _silent_partner_H_
...
typedef struct silent_partner_t silent_partner_t;

#include "instrument_type.h"



typedef struct silent_partner_t {
