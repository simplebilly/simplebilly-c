...
#ifndef _product_create_H_
#define _product_create_H_
...
typedef struct product_create_t product_create_t;

#include "any_type.h"



typedef struct product_create_t {
