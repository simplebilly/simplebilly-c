...
typedef struct contact_t {
    ...
    char *certificate_valid_until; // string
    char *city; // string
    ...
    char *vat_id_validation_date; // string
    char *website; // string
    char *zip; // string
