...
#ifndef _contact_update_H_
#define _contact_update_H_
...
typedef struct contact_update_t contact_update_t;
...
typedef struct contact_update_t {
    ...
    contact_type_t *contact_type; // custom
