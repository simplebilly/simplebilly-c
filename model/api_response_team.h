...
#ifndef _api_response_team_H_
#define _api_response_team_H_
...
typedef struct api_response_team_t api_response_team_t;

#include "api_response_team_data.h"



typedef struct api_response_team_t {
    struct api_response_team_data_t *data; //model
    char *error; // string
    char *message; // string
    int *success; //boolean
