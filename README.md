...
> published under [Releases](https://github.com/simplebilly/simplebilly-c/releases).

## Installation

The package is published to the C package registry (and to [GitHub Packages](https://github.com/orgs/simplebilly/packages)).
See the [Releases](https://github.com/simplebilly/simplebilly-c/releases) page for the list
